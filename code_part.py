...
class ChatBot():
    ...
    def greeting(self):
        text_to_speech("Information Retreiving Chat Bot\n")
        print("Information Retreiving Chat Bot\n")
        sleep(2)
        text_to_speech("Initializing ChatBot ...")
        print("Initializing ChatBot ...\n")
        # some time to get user ready
        sleep(2)
        # chat ending tags
        text_to_speech('Type "bye" or "quit" or "exit" to end chat')
    ...
    def chat(self):
        ...
        while not self.end_chat:
            ...
            if self.end_chat:
                text_to_speech('See you soon! Bye!')
    ...
    def scrape_wiki(self,topic):
        ...
        try:
            ...
            text_to_speech('Topic is "Wikipedia: {}". Let\'s chat!'.format(self.title))
            print('ChatBot >>  Topic is "Wikipedia: {}". Let\'s chat!'.format(self.title)) 
        # in case of unavailable topics
        except Exception as e:
            text_to_speech('Error: {}.             Please input some other topic!'.format(e))
            print('ChatBot >>  Error: {}.             Please input some other topic!'.format(e))
